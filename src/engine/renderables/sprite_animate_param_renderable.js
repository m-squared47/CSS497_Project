...
class SpriteAnimateParamRenderable extends SpriteRenderable {
    constructor(myTexture, repeats) {
        super(myTexture);
   ...
   incAnimationSpeed(
    ...
    updateAnimation() {
        this.mCurrentTick++;
        console.log(this.repeats + " " + this.playedOnce);
        if (this.mCurrentTick >= this.mUpdateInterval && (!this.playedOnce || this.repeats)) {
            this.mCurrentTick = 0;
...
export default SpriteAnimateParamRenderable;